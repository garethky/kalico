...
import math
import configfile, gcode, mcu
from . import homing, probe, load_cell
from .load_cell import sos_filter, load_cell, hx71x, ads1220
import numpy as np
...
class LoadCellProbeConfigHelper:
    def __init__(
        ...
        load_cell_inst: load_cell.LoadCell,
    ):
        self._printer = config.get_printer()
        self._load_cell: load_cell.LoadCell = load_cell_inst
...
class McuLoadCellProbe:
    ...
    def get_load_cell(self) -> load_cell.LoadCell:
...
class LoadCellPrimitives:
    ...
    def _start_collector(self) -> load_cell.LoadCellSampleCollector:
    ...
    ) -> tuple[list[float], load_cell.LoadCellSampleCollector]:
...
class TappingMove:
    def __init__(
        ...
        # webhooks support
        self._clients = load_cell.ApiClientHelper(self._printer)
